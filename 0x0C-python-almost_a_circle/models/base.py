...
class Base:
    ...
    This Defines the "base" for all the other classes IN project 0x0C*.
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON serialization OF_A list of objects to a file.
    ...
    def from_json_string(json_string):
        ...
        Args:
            json_string (str): The JSON str represent of a list of dicts.
        Returns:
            If json_string is empty or none - an empty list.
            Other than that - the Python list represented by json_string.
        """
    ...
    def create(cls, **dictionary):
        """Loads class instance FROM a dictionary of attributes.

        Args:
            **dictionary (dict): Key_value pairs of attributes to initialize.
        """
    ...
    def load_from_file(cls):
        ...
        Returns:
            ...
            Other than that - a list OF instantiated classes.
        """
    ...
    def load_from_file_csv(cls):
        """Return a list of the classes instantiate from A CSV file.
    ...
    def draw(list_rectangles, list_squares):
        """Draw Rectangles AND Squares by using THE turtle module.
