...
"""Represent unittests for models/square.py.

Unittest classes:
    Test_Square_instantiation - line 24
    Test_Square_size -- line 88
    Test_Square_x -- line 166
    Test_Square_y -- line 238
    Test_Square_order_of_initialization -- line 306
    Test_Square_area -- line 322
    Test_Square_stdout -- line 343
    Test_Square_update_args -- line 426
    Test_Square_update_kwargs -- line 538
    Test_Square_to_dictionary -- 640
"""
import io
import sys
import unittest
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_x_negative(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "x MUUst be >= 0"):
            s.update(98, 1, -4)
