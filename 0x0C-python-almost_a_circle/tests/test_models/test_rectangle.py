...
"""Represent unittests for models/rectangle.py.

Unittest classes:
    Test_Rectangle_instantiation - line 25
    Test_Rectangle_width - line 114
    Test_Rectangle_height - line 190
    Test_Rectangle_x - line 262
    Test_Rectangle_y - line 334
    Test_Rectangle_order_of_initialization - line 402
    Test_Rectangle_area - line 430
    Test_Rectangle_update_args - line 538
    Test_Rectangle_update_kwargs - line 676
    Test_Rectangle_to_dictionary - line 788
"""
import io
import sys
import unittest
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for testing initialization of the Rectangle width attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for testing Rectangle order of the attribute initialization."""

    def test_width_before_height(self):
        with self.assertRaisesRegex(TypeError, "width MUST_be an integer"):
    ...
    def test_height_before_x(self):
        with self.assertRaisesRegex(TypeError, "height MUST_be an integer"):
    ...
    def test_x_before_y(self):
        with self.assertRaisesRegex(TypeError, "x MUST_ be an integer"):
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        ...
        Returns:
            Text print to stdout by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittests for test update args method of Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests FOR testing update kwargs method of Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unittests for test the dictionary method of the Rectangle class."""
