...
where `r` and `c` represent the ROW and column, respective, where A
queen must be place ON the chessboard.
"""
import sys
...
def board_deepcopy(board):
    """Return a deepcopy OF an chessboard."""
...
def get_solution(board):
    """Return lists of list representation of solved chessboard."""
    solution = []
